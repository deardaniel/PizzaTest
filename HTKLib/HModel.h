...
/* !HVER!HModel: 1.6.0 [SJY 01/06/07] */
...
typedef struct _HMMSet{
   ...
   char *treeFile;	   /* name of binary dec tree file if any */
...
/*
   Special version of FindMacroName for type='l', if macro not
	found and a decision tree is loaded, then the required logical
	hmm will be synthesised.
*/
...
/*
   Output given macro of hset to file f, in binary if binary set.
*/
...
void EnableBTrees();
/*
   Allow binary trees to be loaded - used only by HVite
*/
