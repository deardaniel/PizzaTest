...
typedef struct {
   ...
   int minFrames;         /* Min frames needed for update */
   float tConst;          /* Time constant */
...
void FZeroMeanCMN(float *data, int vSize, int n, int step,
                  MeanRec *cmn, Boolean isSpeech);
/*
   Zero mean the given data sequence, using the cmn vector if provided
*/
